...
# Google OAuth Nativo (Sustituye a Nango)
GOOGLE_CLIENT_ID = os.getenv("GOOGLE_CLIENT_ID")
GOOGLE_CLIENT_SECRET = os.getenv("GOOGLE_CLIENT_SECRET")
# URL de redirección configurada en Google Cloud (ej: https://tu-backend.onrender.com/auth/google/callback)
...
# ======================
# 1. GOOGLE OAUTH NATIVO (SIN NANGO)
# ======================
...
async def google_callback(code: str):
    ...
    try:
        ...
        # 3. Guardar o actualizar en base de datos de forma estricta por EMAIL (sin duplicar)
        conn = get_db_connection()
        cur = conn.cursor()
        cur.execute("""
        ...
        # 4. Redirigir al cliente de vuelta al frontend con el email o estado de éxito
...
async def sync_crm_schema_to_logs(consumer_id: str):
    ...
    # Intentar detectar qué servicio CRM está activo para este consumidor
